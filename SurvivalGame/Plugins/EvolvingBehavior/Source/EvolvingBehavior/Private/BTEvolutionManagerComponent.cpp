...
void UBTEvolutionManagerComponent::OnRegister()
{
    ...
    ALifeCycleActor* lifeCycle = ALifeCycleActor::GetLifeCycleActor(world);
    if (lifeCycle)
    {
        lifeCycle->OnDeleteSave().AddUObject(this, &UBTEvolutionManagerComponent::DeleteSave);
    }
    ...
    {
        UE_LOG(LogTemp, Warning, TEXT("BTEvolutionManagerComponent::OnRegister - No LifeCycleActor found in world."));
    }
#endif
}
